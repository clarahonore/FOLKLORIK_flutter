...
class LaboEnigme extends StatefulWidget {
  ...
  @override
  State<LaboEnigme> createState() => _Enigme4MenhirsPageState();
}

class _Enigme4MenhirsPageState extends State<LaboEnigme>
          ...
          if (!showSecondImage)
            Center(
              child: FadeTransition(
                ...
                child: const Text(
                  "Cliquer pour regarder de plus près les fioles sur l'étagère",
                  style: TextStyle(
                    fontSize: 22,
                    fontWeight: FontWeight.bold,
                    color: Colors.white,
              ...
              child: Center(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text(
                        "\u2728 Énigme 4 : Ingrédients de la potion",
                        style: TextStyle(
                          fontSize: 24,
                          fontWeight: FontWeight.bold,
                          color: Colors.white,
                      ...
                      const Text(
                        "Remettez les bons ingrédients dans leur fiole respective afin de trouver le remède qui sauvera Merlin.",
